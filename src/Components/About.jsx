export default function About() {
  return (
    <div className="my-16 px-6 sm:px-12 lg:px-20 bg-gray-50 py-20">
      <h1 className="border-b-2 border-gray-300 pb-2 mb-6 text-4xl sm:text-5xl md:text-6xl font-semibold text-gray-800">
        About Me
      </h1>
      <div className="flex flex-col md:flex-row space-y-6 md:space-y-0 md:space-x-12 text-xl">
        {/* Left Section */}
